                  ...
                  <form onSubmit={handleSubmit} className="space-y-10">
                    {isSignUp && (
                      <div className="space-y-2">
                        ...
                        />
                        {errors.name && (
                          <p className="text-sm text-red-500 animate-slideDown">{errors.name}</p>
                        )}
                      </div>
                    )}
                    ...
                    <div className="space-y-2">
                      ...
                      />
                      {errors.email && (
                        <p className="text-sm text-red-500 animate-slideDown">{errors.email}</p>
                      )}
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      {errors.password && (
                        <p className="text-sm text-red-500 animate-slideDown">{errors.password}</p>
                      )}
                    </div>
