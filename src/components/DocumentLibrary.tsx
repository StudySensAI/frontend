  ...
  return (
    <div className="min-h-screen p-6 md:p-10 bg-gradient-to-br from-blue-200 via-white to-purple-200 bg-fixed">
      <div className="max-w-7xl mx-auto space-y-8">
        {/* Header */}
        <div className="p-6 rounded-3xl bg-white/40 backdrop-blur-3xl border border-white/60 shadow-[0_8px_40px_rgba(0,0,0,0.1)]">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <div className="relative flex-1">
            ...
            <Input
              ...
              className="pl-10 bg-white/40 border-white/60 backdrop-blur-2xl shadow-[0_4px_30px_rgba(0,0,0,0.05)] hover:bg-white/60 focus:bg-white/70 transition-all"
            />
          </div>
          <Button
            variant="outline"
            className="gap-2 bg-white/40 border-white/60 backdrop-blur-2xl hover:bg-white/60 shadow-[0_4px_30px_rgba(0,0,0,0.05)]"
          >
        ...
        <Card
          ...
          ${
            dragActive
              ? 'border-blue-500 bg-blue-100/50 shadow-[0_12px_60px_rgba(59,130,246,0.25)] scale-[1.02]'
              : 'border-white/60 bg-white/40 hover:bg-white/60 shadow-[0_8px_50px_rgba(0,0,0,0.08)]'
          }`}
          ...
          <div className="text-center space-y-4">
            <div
              className={`w-16 h-16 mx-auto rounded-full flex items-center justify-center transition-all ${
                dragActive ? 'bg-gradient-to-br from-blue-500 to-indigo-500 shadow-[0_8px_40px_rgba(59,130,246,0.3)] scale-110' : 'bg-blue-100/70'
              }`}
            >
              <Upload className={`w-8 h-8 ${dragActive ? 'text-white' : 'text-blue-600'}`} />
            </div>
            <h3 className="text-lg font-medium text-gray-800">Upload Study Materials</h3>
            <p className="text-sm text-gray-600">Drag and drop your PDFs, notes, or documents here</p>
            <div className="flex items-center justify-center gap-3">
              <Button className="bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 text-white font-medium shadow-[0_4px_30px_rgba(59,130,246,0.3)] hover:shadow-[0_6px_40px_rgba(59,130,246,0.4)] transition-all">
            ...
            <p className="text-xs text-gray-500">Supports: PDF, DOC, DOCX, TXT (Max 25MB)</p>
          </div>
        </Card>
        ...
        <div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {documents.map((doc) => (
              <Card
                key={doc.id}
                className="p-5 rounded-3xl border border-white/60 bg-white/40 backdrop-blur-3xl 
                           shadow-[0_12px_40px_rgba(0,0,0,0.08)] hover:shadow-[0_16px_60px_rgba(0,0,0,0.12)]
                           hover:bg-white/60 transition-all"
              >
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <div className="w-12 h-12 bg-gradient-to-br from-blue-100 to-blue-200/70 rounded-xl flex items-center justify-center shadow-inner">
                  ...
                  <div className="flex items-center gap-2 pt-2 border-t border-white/60">
                    <Button size="sm" variant="ghost" className="flex-1 gap-2 hover:bg-white/50 backdrop-blur-md">
                      <Eye className="w-4 h-4" />
                      View
                    </Button>
                    <Button size="sm" variant="ghost" className="hover:bg-white/50 backdrop-blur-md">
                      <Download className="w-4 h-4" />
                    </Button>
                    <Button
                      size="sm"
                      variant="ghost"
                      className="text-red-600 hover:text-red-700 hover:bg-red-100/50 backdrop-blur-md"
                    >
