...
export function ProgressTracker() {
  ...
  return (
    <div className="min-h-screen p-6 md:p-10 bg-gradient-to-br from-blue-200 via-white to-purple-200 bg-fixed">
      <div className="max-w-7xl mx-auto space-y-8">
        {/* Header */}
        <div className="p-6 rounded-3xl bg-white/40 border border-white/60 backdrop-blur-2xl shadow-[0_8px_40px_rgba(0,0,0,0.08)]">
          <h1 className="text-3xl font-semibold text-gray-800">Progress Tracker</h1>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            { label: 'Total Hours', value: '124', sub: '+12% this week', icon: Clock, color: 'from-blue-500 to-indigo-500', textColor: 'text-blue-600' },
            { label: 'Avg Score', value: '87%', sub: '+3% this week', icon: Target, color: 'from-green-500 to-emerald-500', textColor: 'text-green-600' },
            { label: 'Current Streak', value: '7 days', sub: "Don't break it!", icon: Zap, color: 'from-orange-500 to-yellow-500', textColor: 'text-orange-600' },
            { label: 'Achievements', value: '12', sub: '2 more unlocked!', icon: Award, color: 'from-purple-500 to-pink-500', textColor: 'text-purple-600' },
          ].map((stat, i) => {
            const Icon = stat.icon;
            return (
              <Card
                key={i}
                className="p-5 rounded-3xl bg-white/40 border border-white/60 backdrop-blur-2xl shadow-[0_8px_40px_rgba(0,0,0,0.08)] hover:shadow-[0_12px_50px_rgba(0,0,0,0.1)] transition-all"
              >
                <div className="flex items-start justify-between">
                  ...
                  <div
                    className={`w-10 h-10 rounded-xl flex items-center justify-center bg-gradient-to-br ${stat.color} text-white shadow-md`}
                  >
          ...
          <Card className="p-6 rounded-3xl bg-white/40 border border-white/60 backdrop-blur-2xl shadow-[0_8px_40px_rgba(0,0,0,0.08)]">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Badge className="bg-gradient-to-r from-blue-500 to-indigo-500 text-white gap-2 shadow-md">
                  ...
                  <div key={day.day} className="space-y-2">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <div className="flex items-center gap-4">
                        <span className="text-gray-800">{day.hours}h</span>
                  ...
                  return (
                    <div
                      ...
                      className={`p-4 rounded-2xl border transition-all ${
                        a.earned
                          ? 'border-white/60 bg-white/60 shadow-[0_4px_20px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_30px_rgba(0,0,0,0.08)]'
        ...
        {/* Subject Progress */}
        <Card className="p-6 rounded-3xl bg-white/40 border border-white/60 backdrop-blur-2xl shadow-[0_8px_40px_rgba(0,0,0,0.08)]">
          <h2 className="text-lg mb-4 font-medium text-gray-800">Subject Progress</h2>
            ...
            {subjects.map((s) => (
              <div key={s.name} className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-medium text-gray-800 ">{s.progress}%</span>
                </div>
                <div className="relative w-full h-2 bg-white/40 rounded-full overflow-hidden shadow-inner">
  <div
    className="absolute left-0 top-0 h-full rounded-full 
              bg-gradient-to-r from-[#3A7BD5] to-[#00D2FF]
  ...
  />
        ...
        {/* Study Calendar */}
        <Card className="p-6 rounded-3xl bg-gradient-to-br from-blue-500/90 to-indigo-500/90 text-white shadow-[0_8px_50px_rgba(59,130,246,0.3)] backdrop-blur-2xl">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-4">
                <div className="relative flex-1 h-2 bg-white/30 rounded-full overflow-hidden shadow-inner">
  <div
    className="absolute left-0 top-0 h-full rounded-full 
